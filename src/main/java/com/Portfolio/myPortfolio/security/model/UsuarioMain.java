package com.Portfolio.myPortfolio.security.model;
...
public class UsuarioMain implements UserDetails {
    ...
    // GranthedAuthority de Spring security
    ...
    //stream en java son como envoltorios de colecciones de datos que nos permiten operar con estas 
    //colecciones y hacer que el procesamiento de datos sea mas rapido y facil de leer
